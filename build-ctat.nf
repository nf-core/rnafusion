...
process star_fusion {
    ...
    wget ${ctat_url} -O CTAT_HumanFusionLib.dat.gz
    ...
    prep_genome_lib.pl \\
        --genome_fa ${fasta} \\
        --gtf ${gtf} \\
        --annot_filter_rule /opt/conda/envs/nf-core-rnafusion-star-fusion_1.9.1/lib/STAR-Fusion/ctat-genome-lib-builder/AnnotFilterRuleLib/AnnotFilterRule.pm \\
