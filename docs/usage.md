...
2. Detecting fusions
   ...
   - QC: `Fastqc`, `MultiQC`, and `Mosdepth`, `Picard CollectInsertSize`, `Picard CollectWgsMetrics`, `Picard Markduplicates`
...
This will skip all QC-related processes (metrics collection, `Mosdepth`)
