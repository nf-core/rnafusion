...
# Test batch mode
nextflow run nf-core/rnafusion -profile munin -c '/data1/references/rnafusion/1.1.0/munin-singularity.config' --reads '/data1/references/rnafusion/1.1.0/batch_data/00*/*_R{1,2}.fq.gz' --arriba --star_fusion --fusioncatcher --ericscript --pizzly --squid
